...
public class BattletowerbossEntity extends FeatureTest01ModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("battletowerboss").setRegistryName("battletowerboss");
	public BattletowerbossEntity(FeatureTest01ModElements instance) {
		super(instance, 109);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BattletowerbossRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16580450, -16613243, new Item.Properties().group(BattleBornItemGroup.tab))
				.setRegistryName("battletowerboss_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(FreezingbattleaxeItem.block, (int) (1)));
		}
		...
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.stone.break")), 0.15f,
					1);
		}
