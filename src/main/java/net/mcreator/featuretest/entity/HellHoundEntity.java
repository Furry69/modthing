...
import net.mcreator.featuretest.procedures.HellHoundRightClickedOnEntityProcedure;
import net.mcreator.featuretest.entity.renderer.HellHoundRenderer;
...
public class HellHoundEntity extends FeatureTest01ModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.9f, 0.9f)).build("hell_hound").setRegistryName("hell_hound");
	public HellHoundEntity(FeatureTest01ModElements instance) {
		super(instance, 70);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HellHoundRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3452651, -9304827, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("hell_hound_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				HellHoundRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (new ItemStack(Items.FIRE_CHARGE, (int) (1)).getItem() == stack.getItem())
				return true;
			return false;
		}
