...
import net.mcreator.featuretest.entity.renderer.BloodslimeminiRenderer;
import net.mcreator.featuretest.FeatureTest01ModElements;

import java.util.Random;

@FeatureTest01ModElements.ModElement.Tag
public class BloodslimeminiEntity extends FeatureTest01ModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 1f))
					.build("bloodslimemini").setRegistryName("bloodslimemini");
	public BloodslimeminiEntity(FeatureTest01ModElements instance) {
		super(instance, 108);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BloodslimeminiRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9305341, -1048576, new Item.Properties().group(BattleBornItemGroup.tab))
				.setRegistryName("bloodslimemini_spawn_egg"));
	}
