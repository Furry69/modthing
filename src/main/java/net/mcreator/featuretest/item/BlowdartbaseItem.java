...
public class BlowdartbaseItem extends FeatureTest01ModElements.ModElement {
	@ObjectHolder("feature_test_01:blowdartbase")
	public static final Item block = null;
	public BlowdartbaseItem(FeatureTest01ModElements instance) {
		super(instance, 75);
	}
