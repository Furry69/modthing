...
public class EridiumItem extends FeatureTest01ModElements.ModElement {
	@ObjectHolder("feature_test_01:eridium")
	public static final Item block = null;
	public EridiumItem(FeatureTest01ModElements instance) {
		super(instance, 1);
	}
